...
const Home = () => {
  ...
  <div className='grid grid-cols-2'>
    <div className='max-w-full align-middle h-3.5 items-center justify-center p-8'>
    ...
    <div className="max-h-screen flex flex-col items-center justify-center p-8">
        <div className="w-full text-center">
            ...
            <h1 className="text-4xl font-medium my-3">Ali Burhan(BURHANSE)</h1>
        ...
        <div className="w-3/4 text-center my-3">
            ...
            <div className="flex justify-center">
                <Link href="#" onClick={()=>{alert("Did'nt make any resume yet.")}} className="px-4 py-2 rounded-lg text-white bg-indigo-500 hover:bg-indigo-600">Resume</Link>
